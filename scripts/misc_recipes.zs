...
craftingTable.addShaped("novelty_hat", <item:alexsmobs:novelty_hat>, [
    ...
    [<item:minecraft:brain_coral_block>, <item:etcetera:light_blue_hat>, <item:minecraft:brain_coral_block>],
...
furnace.addRecipe("gilded_blackstone_to_gold", <item:minecraft:gold_nugget> * 2, <item:minecraft:gilded_blackstone>, 0.35, 200);
...
craftingTable.addShaped("ancient_rod", <item:kubejs:ancient_rod> * 2, [
...
craftingTable.addShaped("permafrost", <item:quark:permafrost> * 2, [
    [<item:minecraft:coarse_dirt>, <item:minecraft:packed_ice>],
    [<item:minecraft:packed_ice>, <item:minecraft:coarse_dirt>]]);
...
//craftingTable.addShaped("studded_helmet", <item:rediscovered:studded_helmet>, [
...
//craftingTable.addShaped("studded_chestplate", <item:rediscovered:studded_chestplate>, [
    //[<item:minecraft:air>, <item:minecraft:leather>, <item:minecraft:air>], 
...
//craftingTable.addShaped("studded_leggings", <item:rediscovered:studded_leggings>, [
    //[<item:minecraft:air>, <item:minecraft:leather>, <item:minecraft:air>], 
...
//craftingTable.addShaped("studded_boots", <item:rediscovered:studded_boots>, [
    //[<item:minecraft:air>, <item:minecraft:leather>, <item:minecraft:air>], 
...
craftingTable.addShapeless("tangle_roots_hanging_roots", <item:spelunkery:tangle_roots>, [<item:minecraft:hanging_roots>]);
...
craftingTable.addShaped("rock_salt", <item:kubejs:rock_salt>, [
    [<item:kubejs:salt>, <item:kubejs:salt>, <item:kubejs:salt>],
    [<item:kubejs:salt>, <item:kubejs:salt>, <item:kubejs:salt>],
    [<item:kubejs:salt>, <item:kubejs:salt>, <item:kubejs:salt>]]);

craftingTable.addShaped("halite_block", <item:kubejs:halite_block>, [
    [<item:kubejs:halite_crystal>, <item:kubejs:halite_crystal>, <item:kubejs:halite_crystal>],
    [<item:kubejs:halite_crystal>, <item:kubejs:halite_crystal>, <item:kubejs:halite_crystal>],
    [<item:kubejs:halite_crystal>, <item:kubejs:halite_crystal>, <item:kubejs:halite_crystal>]]);
...
craftingTable.addShaped("doormat", <item:supplementaries:doormat> * 3, [
    [<item:minecraft:wheat>, <item:etcetera:cotton_flower> | <item:alexsmobs:bison_fur> | <item:alexsmobs:bear_fur>, <item:minecraft:wheat>],
    [<item:etcetera:cotton_flower> | <item:alexsmobs:bison_fur> | <item:alexsmobs:bear_fur>, <item:minecraft:wheat>, <item:etcetera:cotton_flower> | <item:alexsmobs:bison_fur> | <item:alexsmobs:bear_fur>]]);
...
craftingTable.addShaped("elytra", <item:minecraft:elytra>, [
    [<item:minecraft:phantom_membrane>, <item:kubejs:ancient_rod>, <item:minecraft:phantom_membrane>],
...
//Potions:
    ...
    //Other:
        brewing.addRecipe(<item:spelunkery:portal_fluid_bottle>, <item:phantasm:crystal_shard>, <item:minecraft:potion>.withTag({Potion: "galosphere:astral"}));
...
craftingTable.addShapeless("glow_paste_glow_shroom_block", <item:kubejs:glow_paste> * 9, [<item:quark:glow_shroom_block> | <item:spelunkery:phosphor_fungus_block> | <item:spelunkery:mushgloom_block>]);
craftingTable.addShapeless("glow_paste_glow_shroom", <item:kubejs:glow_paste>, [<item:quark:glow_shroom> | <item:spelunkery:phosphor_fungus> | <item:minecraft:glow_lichen> | <item:galosphere:glow_ink_clumps> | <item:quark:glow_shroom_ring> | <item:quark:glow_lichen_growth> | <item:spelunkery:mushgloom>]);
...
craftingTable.remove(<item:upgrade_aquatic:luminous_prismarine>);
craftingTable.addShaped("luminous_prismarine", <item:upgrade_aquatic:luminous_prismarine>, [
    ...
    [<item:minecraft:prismarine_shard>, <item:kubejs:glow_paste>, <item:minecraft:prismarine_shard>],
    [<item:minecraft:prismarine_shard>, <item:minecraft:prismarine_shard>, <item:minecraft:prismarine_shard>]]);
