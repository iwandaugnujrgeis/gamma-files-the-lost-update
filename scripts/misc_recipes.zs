...
craftingTable.addShaped("supplementaries_rope", <item:supplementaries:rope> * 8, [[<item:spelunkery:tangle_roots>], [<item:spelunkery:tangle_roots>], [<item:spelunkery:tangle_roots>]]);
