...
craftingTable.addShapedMeta("lodestone", <item:minecraft:lodestone>, [
  ...
  [<item:minecraft:chiseled_stone_bricks>, <item:minecraft:redstone>, <item:minecraft:chiseled_stone_bricks>]], "", <constant:minecraft:recipe/category/crafting:misc>);
...
craftingTable.addShaped("bamboo_raft", <item:minecraft:bamboo_raft>, [ 
  [<item:minecraft:bamboo_planks>, <item:minecraft:air>, <item:minecraft:bamboo_planks>], 
...
furnace.addRecipe("glow_paste_smelt", <item:kubejs:glow_paste>, <item:minecraft:glow_lichen>, 0.35, 200);
