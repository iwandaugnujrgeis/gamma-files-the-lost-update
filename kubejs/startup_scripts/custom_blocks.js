...
//3.19:
      //event.create('smooth_stone_slab', 'slab').displayName('Smooth Stone Slab').soundType('stone').hardness(2).resistance(2).tagBlock('minecraft:mineable/pickaxe').requiresTool(true)
