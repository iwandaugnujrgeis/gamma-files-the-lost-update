...
//3.8:
      event.create('suspicious_block').displayName('Suspicious Block').textureAll('gamma:block/suspicious_block').soundType('amethyst').hardness(3).resistance(2).tagBlock('minecraft:mineable/pickaxe').requiresTool(true)
...
//Other:
      ...
      event.create('halite_block').displayName('Halite Block').textureAll('gamma:block/halite_block').soundType('calcite').hardness(1.6).resistance(2).slipperiness(0.8).tagBlock('minecraft:mineable/pickaxe').requiresTool(true)
})