...
ItemEvents.modification(event => {
	...
	stackTo1('upgrade_aquatic:bedroll')
	stackTo1('upgrade_aquatic:white_bedroll')
	stackTo1('upgrade_aquatic:light_gray_bedroll')
	stackTo1('upgrade_aquatic:gray_bedroll')
	stackTo1('upgrade_aquatic:black_bedroll')
	stackTo1('upgrade_aquatic:brown_bedroll')
	stackTo1('upgrade_aquatic:red_bedroll')
	stackTo1('upgrade_aquatic:orange_bedroll')
	stackTo1('upgrade_aquatic:yellow_bedroll')
	stackTo1('upgrade_aquatic:lime_bedroll')
	stackTo1('upgrade_aquatic:green_bedroll')
	stackTo1('upgrade_aquatic:cyan_bedroll')
	stackTo1('upgrade_aquatic:light_blue_bedroll')
	stackTo1('upgrade_aquatic:blue_bedroll')
	stackTo1('upgrade_aquatic:purple_bedroll')
	stackTo1('upgrade_aquatic:magenta_bedroll')
	stackTo1('upgrade_aquatic:pink_bedroll')
})
